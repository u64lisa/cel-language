...
public class FunctionDeclareNode extends Node {
    ...
    public FunctionDeclareNode(Token name, List<Token> argumentNames, List<Token> argumentTypes, Node body,
        ...
        startPosition = name != null ? name.getStartPosition() : (
                argumentNames != null && argumentNames.size() > 0 ? argumentNames.get(0).getStartPosition() : body.getStartPosition()
                );
        endPosition = body.getEndPosition();
        nodeType = NodeType.FUNCTION_DEFINITION;
    }

    public FunctionDeclareNode setCatcher(boolean c) {
        this.catcher = c;
        return this;
    }
    ...
    public Node optimize() {
        ...
        return new FunctionDeclareNode(name, argumentNames, argumentTypes, body, autoreturn, async, returnType,
